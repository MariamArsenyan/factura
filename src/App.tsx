...
export const App: React.FC = () => {
  ...
  const totalPrice = selectedServices.reduce((acc, index) => acc + services[index].price, 0);

  return (
    <div className="app  p-5 flex flex-col items-center max-w-full max-h-full gap-11">
        <Navbar/>
        <Title/>
